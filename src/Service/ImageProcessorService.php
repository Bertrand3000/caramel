...
class ImageProcessorService
{
    ...
    {
        return $this->saveAs($file, '/public/uploads/produits', 'jpg', true);
    }

    public function processInventoryPhoto(UploadedFile $file): string
    {
        return $this->saveAs($file, '/public/uploads/inventaire', 'png', false);
    }

    private function saveAs(UploadedFile $file, string $path, string $extension, bool $jpeg): string
    {
